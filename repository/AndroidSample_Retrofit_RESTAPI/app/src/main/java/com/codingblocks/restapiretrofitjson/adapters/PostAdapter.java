...
import com.codingblocks.restapiretrofitjson.activities.CommentsActivity;
...
public class PostAdapter
    ...
    public void onBindViewHolder(PostViewHolder holder, int position) {
        ...
        holder.btnPostcmnt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(onItemClickListener!=null)
                {
                    onItemClickListener.onItemClick(thisPost.getId(), CommentsActivity.class);
                }
            }
        });
    }
    ...
    class PostViewHolder extends RecyclerView.ViewHolder {
        ...
        public PostViewHolder(View itemView) {
            ...
            btnPostcmnt = (Button) itemView.findViewById(R.id.btnPostcmnt);
        }
    }
}
